...
Técnicas como instruction tuning dieron pie a los modelos instruct, que son la base de los asistentes de hoy en día, ya que estos están afinados para seguir instrucciones \cite{ouyang2022instructgpt}.
...
\vspace{15px}
Entre 2023 y 2026, la investigación sobre seguridad en LLMs experimentó un crecimiento significativo:

\begin{itemize}
    \item Más de 1400 publicaciones académicas sobre vulnerabilidades relacionadas con el prompt injection (en arxiv.org)
...
\begin{itemize}
    \item \textbf{Govern}: establece políticas, roles, etc.
    \item \textbf{Map}: analiza el contexto de uso del sistema, a quién afecta y sus posibles impactos.
    \item \textbf{Measure}: evalúa y monitoriza riesgos, desempeño y vulnerabilidades.
    \item \textbf{Manage}: aplica medidas para reducir esos riesgos y los mitiga de forma continua.
\end{itemize}
