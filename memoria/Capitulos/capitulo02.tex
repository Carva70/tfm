...
NIST proporciona el AI Risk Management Framework (AI RMF) \cite{nist_ai_rmf}, un marco integral para:

\begin{itemize}
    \item Gestión de riesgos en sistemas de IA a lo largo de su ciclo de vida.
    \item Evaluación de seguridad y confiabilidad de modelos de lenguaje.
    \item Estándares para la documentación y trazabilidad de sistemas de IA.
    \item Medidas de protección contra ataques adversariales.
\end{itemize}

El framework establece cuatro funciones principales: Gobernar, Mapear, Medir y Gestionar, proporcionando un enfoque sistemático para identificar y mitigar riesgos en sistemas de IA.
