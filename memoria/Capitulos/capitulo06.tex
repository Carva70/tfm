...
\begin{itemize}
    ...
    \item \textbf{Evitar exposición de información técnica}: Se recomienda limitar la exposición pública de información técnica y operativa cuando no sea imprescindible. (Limit Public Release of Information, ID: AML.M0000)
    \item \textbf{Concienciación}: capacitación de usuarios y equipos técnicos para detectar inyecciones, ingeniería social y uso inseguro de herramientas, con guías prácticas y simulaciones periódicas. (User Training, ID: AML.M0018)
    ...
    \item \textbf{Human In-the-Loop}: Los sistemas deben exigir que el usuario apruebe las acciones del agente antes de que este las lleve a cabo. Existen herramientas independientes, como agentes de auditoría dedicados, que pueden ayudar en la aprobación humana, pero la decisión final debe recaer en un responsable humano. (Human In-the-Loop for AI Agent Actions, ID: AML.M0029)
\newpage
\end{itemize}
\begin{figure}[H]
...
\section{Limitaciones conocidas de los controles propuestos}\label{sec:limitaciones-controles}
